			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<div class="col-md-8  pre-scrollable">
						<div id="msg" class="list-group"></div>
					</div>
					<div class="col-md-5">
						<form action="#">
							<div class="form-group">
								<label for="text">回复留言内容</label>
								<textarea class="form-control" id="text" rows="5" cols="10" placeholder="请输入回复内容"></textarea>
								<button type="button" class="btn btn-default mar_t15" onclick="sendMsgByAd()">回复</button>
							</div>
						</form>
					</div>
				</div>
			...
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					...
					<div class="modal-body">
						<div id="msgDiv" class="modal-body pre-scrollable"></div>
						<div class="panel panel-default">
							<div class="panel-body">
								<!-- <div class="col-md-12  pre-scrollable">
								<div id="msgDiv" class="list-group"></div>
							</div> -->
								<div class="col-md-12">
									<form action="#">
										<div class="form-group">
											<label for="text">回复留言内容</label>
											<textarea class="form-control" id="text" rows="5" cols="10" placeholder="请输入回复内容"></textarea>
											<button type="button" class="btn btn-default" onclick="sendMsgByAd()">发送</button>
										</div>
									</form>
								</div>
							</div>
